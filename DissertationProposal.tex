...
\paragraph{Participants} 16 participants will be recruited from amongst students who have taken 22c:019 Discrete Math and 22c:021 Data Structures

\paragraph{Procedures}

\paragraph{Experimental Design}

 materials, participants, procedures, and experimental design.



  The rough plan for the experiment is to first take participants through a tutorial on proving theorems in propositional and first-order logic with Coq.  Participants will then walk through a pair complicated proofs, using Proof Transitions for one and un-extended CoqEdit for the other, and will be asked to give detailed explanations of what they see.  These explanations will be recorded and graded later.  Finally, participants will be given two sets of lemmas to attempt to prove, one with Proof Previews and the other without, and the amount of time they need (or the number they are able to prove) will be recorded.  For both the Proof Transitions and the Proof Previews, ordering of problems and pairing of problem to extension will be balanced across participants, and informal feedback will be acquired along the way.
