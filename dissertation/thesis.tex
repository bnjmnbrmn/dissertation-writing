...
This brings us to the question of where to go from here.  I see at least five paths.  First is the next iteration of refinement and testing of Proof Transitions.  This might include:
...
\begin{itemize}
 ...
 \item Better systems for node traversal (in-order)
 \item Mini-map / multiple zooming levels
\end{itemize}

There are also ``larger'' problems that need to be addressed:

\begin{itemize}
 \item Integration w/ editor
 \item Large nodes
 \item Building the tree
 \item Mechanism for tactics
\end{itemize}
