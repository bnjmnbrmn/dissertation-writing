...
\autoref{tab:tabptratings} and \autoref{tab:nonptratings} show the questionnaire rating averages for the proof interpretation/explanation with Proof Transitions and the basic CoqEdit interface respectively.  %TO DO
