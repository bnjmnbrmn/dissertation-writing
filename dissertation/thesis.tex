...
At the zoomed-in level two nodes are always visible:  the ``current'' node, which has its top box colored orange, and the current node's parent node. 
...
\begin{figure}[H]
  \center
  \includegraphics[width=\linewidth]{ptsecondchildzoomedout.jpg}
  \caption{}
...
\begin{figure}[H]
  \center
  \includegraphics[width=\linewidth]{ptthirdchildzoomedout.jpg}
  \caption{}
...
\begin{figure}[H]
  \center
  \includegraphics[width=\linewidth]{ptfourthgrandchildzoomedout.jpg}
  \caption{}
