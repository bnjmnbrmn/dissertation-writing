...
\item Blinking yellow highlighting is used to show where the tactic is finding or producing matching text.  For the sake of brevity, this is only shown in {fig:ptdestructor0} through \autoref{fig:ptdestructor6} and not in \autoref{fig:ptdestructand}.  Blinking occurs at a rate of ... TO DOPressing T again, or moving to a different node, clears the red and green highlighting and stops the animation.
\end{itemize}
