...
In \autoref{fig:ptdestructand} through \autoref{fig:ptdestructor6} we see the other major feature of Proof Transitions---transition highlighting and animation.  Pressing the T key has the following effects:
...
\begin{figure}[H]
  \center
  \includegraphics[width=\linewidth]{ptdestructor3.jpg}
  \caption{}
...
\begin{figure}[H]
  \center
  \includegraphics[width=\linewidth]{ptdestructor4.jpg}
  \caption{}
...
\begin{figure}[H]
  \center
  \includegraphics[width=\linewidth]{ptdestructor6.jpg}
  \caption{}
  \label{fig:ptdestructor6}
\end{figure}
