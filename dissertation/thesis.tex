...
\begin{itemize}
 ...
 \item Visualizing advanced tactics that actually have effects on unproved goals other than the current goal.  These are not necessary, and users could be prevented from using these, but some relatively minor modifications to the existing visualization could probably be used to represent these.
\end{itemize}
